...
const About = () => {
  return (
    <div className='about'>
      <p class="p1">Rick y Morty es una serie de televisión estadounidense de animación para adultos creada por Justin Roiland y Dan Harmon en 2013 para Adult Swim, también se emitió en Cartoon Network.</p>
      <iframe width="560" height="315" className='video' src="https://www.youtube.com/embed/E8cXKMR9a1Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen ></iframe>
